...
| (7) 과제 내용 요약 | **[프로젝트 개요]**<br>숏폼 시장의 가파른 성장으로 영향력이 커지면서, 트렌드 분석의 중요성과 이를 도와주는 툴의 필요도가 상승하였습니다. 본 프로젝트는 초보 여행 숏폼 유튜버를 위하여 국내 여행 트렌드를 분석하고 사용자가 여행 숏폼 제작에 참고할 수 있는 **주간 여행 트렌드 대시보드를 제공**합니다. 또한 사용자가 제작한 영상을 분석하여 **현재 트렌드를 반영한 피드백 보고서를 제공**합니다.<br><br>**[주요기능]**<br>**1.트렌드 대시보드 제공**<br>틱톡과 유튜브 데이터를 크롤링하여 인기 급상승 여행 해시태그와 인기 여행 동영상 정보를 제공한다.<br>**2.피드백 보고서 제공**<br>사용자가 여행 영상을 어플리케이션에 업로드하면, 영상의 키워드를 추출하여, 맞춤형 제목과 여행 해시태그를 생성하고, 사용자가 업로드 한 영상과 연관성이 높은 여행 유튜브 영상을 추천한다.<br>**3.키워드 검색**<br>사용자가 영상 기획 단계에서 참고할 수 있도록 키워드로 연관 유튜브 여행 영상 검색 기능을 제공한다.   |
