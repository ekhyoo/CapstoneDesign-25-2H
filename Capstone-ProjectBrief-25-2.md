...
# Team-13
| (1) 과제명 |  프랜차이즈 베이커리 가맹점의 POS 데이터를 활용한 품목별 수요 예측 시스템 개발 |
|:---  |---  |
| (2) 팀 번호/이름 | 13-e시크 |
| (3) 구성원 | 이지원(2176297): 리더,*역할,...* <br> 김도희(2170009): 팀원,*역할,....* <br> 변아연(2271032): 팀원,*역할,....* |
| (4) 지도교수 | 이형준 교수 |
| (5) 트랙  | 산학 |
| (6) 과제 키워드 | POS 데이터, 수요 예측, 베이커리, 머신러닝, MOQ, Streamlit |
| (7) 과제 내용 요약 |   |
| (8) 주요 Link |  |
