...
| (7) 과제 내용 요약 | 1. 전통주 종합 정보 제공: 650여종 전통주의 상세 정보(이름, 주종, 도수, 가격, 맛 특성, 페어링 음식, 제조사 등) 통합 제공 <br>2. AI 기반 개인화 추천: AWS Personalize를 활용해 사용자의 취향 테스트, 조회 기록, 찜 목록, 리뷰 평점을 분석하여 맞춤형 전통주 추천 <br>3. Gemini 챗봇 큐레이션: 자유 대화를 통해 사용자의 상황, 감정, 선호도를 파악하고 적합한 전통주와 음식 페어링 추천 <br>4. OCR 기반 즉시 검색: Naver Clova OCR로 전통주 라벨 촬영만으로 해당 제품의 상세 정보를 즉시 확인 |
